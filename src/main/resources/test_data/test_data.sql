...
INSERT INTO `users` (`fullname`, `password`, `role`, `username`)
	VALUES 		(`fullname1`, `$2a$12$Oy/UKrmNbRccE9Gc6LZ3C.n20H//ezfWYKJAuM8XwMrqbcq6V1qPK`, `USER`, `username1`),
			(`fullname2`, `$2a$12$Oy/UKrmNbRccE9Gc6LZ3C.n20H//ezfWYKJAuM8XwMrqbcq6V1qPK`, `USER`, `username2`),
			(`fullname3`, `$2a$12$Oy/UKrmNbRccE9Gc6LZ3C.n20H//ezfWYKJAuM8XwMrqbcq6V1qPK`, `USER`, `username3`),
			(`fullname4`, `$2a$12$Oy/UKrmNbRccE9Gc6LZ3C.n20H//ezfWYKJAuM8XwMrqbcq6V1qPK`, `USER`, `username4`),
			(`fullname5`, `$2a$12$Oy/UKrmNbRccE9Gc6LZ3C.n20H//ezfWYKJAuM8XwMrqbcq6V1qPK`, `USER`, `username5`);
...
INSERT INTO `trade` (`account`,`buy_quantity`,`type`) VALUES ('', '', '') 
	 VALUES 	('account1', '10.00', 'type1'),
			('account2', '20.00', 'type2'),
			('account3', '30.00', 'type3'),
			('account4', '40.00', 'type4'),
