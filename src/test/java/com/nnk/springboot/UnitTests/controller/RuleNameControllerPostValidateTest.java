...
//    	when(ruleNameService.addRuleName(any(RuleNameDTO.class))).thenReturn(any(RuleNameDTO.class));
    ...
    @DisplayName(" Url request /ruleName/validate - Description With Symbols "
...
//    	when(ruleNameService.addRuleName(any(RuleNameDTO.class))).thenReturn(any(RuleNameDTO.class));
    ...
    @DisplayName(" Url request /ruleName/validate - Description length > 125 "
...
//    	when(ruleNameService.addRuleName(any(RuleNameDTO.class))).thenReturn(any(RuleNameDTO.class));
    ...
    @DisplayName(" Url request /ruleName/validate - Json length > 125 "
...
//    	when(ruleNameService.addRuleName(any(RuleNameDTO.class))).thenReturn(any(RuleNameDTO.class));
    ...
    @DisplayName(" Url request /ruleName/validate - Template length > 512 "
...
//    	when(ruleNameService.addRuleName(any(RuleNameDTO.class))).thenReturn(any(RuleNameDTO.class));
    ...
    @DisplayName(" Url request /ruleName/validate - SqlStr length > 125 "
...
//    	when(ruleNameService.addRuleName(any(RuleNameDTO.class))).thenReturn(any(RuleNameDTO.class));
    ...
    @DisplayName(" Url request /ruleName/validate - SqlPart length > 125 "
